...
- continuous mode: in this mode, `coq-lsp` will try to complete
...
- on-demand mode: in this mode, `coq-lsp` will do nothing when
...
- on-demand mode, with viewport hints: in this mode, inspired by
